...
from torchtoolbox.tools.convert_lmdb import generate_lmdb_dataset
...
parser.add_argument('--train', action='store_true', help='train dataset or not.')
...
data_set = ImageNet(args.data_dir, args.train, args.download)
